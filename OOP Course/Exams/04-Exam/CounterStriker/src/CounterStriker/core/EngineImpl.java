...
public class EngineImpl implements Engine {
    ...
    private String addGun(String[] data) {
        ...
        String message = controller.addGun(type, name, bulletsCount);
    ...
    private String addPlayer(String[] data) {
        ...
        String message = controller.addPlayer(type, username, health, armor, gunName);
    ...
    private String start() {
        ...
        String message = controller.startGame();
