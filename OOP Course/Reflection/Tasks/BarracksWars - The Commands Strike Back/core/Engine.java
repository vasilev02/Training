...
public class Engine implements Runnable {
	...
	private static final String COOMAND_PATH = "barracksWars.core.commands.";
	...
	private String interpretCommand(String[] data, String commandName) throws ExecutionControl.NotImplementedException {
		...
		try {
			...
			Class<? extends Executable> clazz = (Class<? extends Executable>) Class.forName(COOMAND_PATH+commandName);
