...
public class UserRegisterController {
    ...
    public String registerUser(@Valid UserRegisterBindingModel userRegisterBindingModel,
        ...
        if (this.userService.checkUsernameExistence(userRegisterBindingModel.getUsername())) {
            redirectAttributes.addFlashAttribute("userRegisterBindingModel", userRegisterBindingModel);
            redirectAttributes.addFlashAttribute("usernameExists", true);
            return "redirect:/users/register";
        }

        if (this.userService.checkEmailExistence(userRegisterBindingModel.getEmail())) {
            redirectAttributes.addFlashAttribute("userRegisterBindingModel", userRegisterBindingModel);
